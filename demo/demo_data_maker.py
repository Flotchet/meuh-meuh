#create a db with a user table with the fields id, username, password, attr_level, points, sick_days, holidays, late_hours
# the usernames are in names.txt
...
def make_db(names, report_types):
    #create a database
    engine = sqlalchemy.create_engine('sqlite:///' + os.path.join(curr, 'users.db'))
    conn = engine.connect()

    #create a table
    conn.execute(sqlalchemy.text("""CREATE TABLE users (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        username TEXT NOT NULL,
        password TEXT NOT NULL,
        attr_level INTEGER NOT NULL,
